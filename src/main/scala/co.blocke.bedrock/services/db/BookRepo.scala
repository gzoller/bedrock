...
final case class MockBookRepo() extends BookRepo:
  /**
    ...
    */
  val book1: Book = Book("Programming in Scala", List("Martin Odersky", "Lex Spoon", "Bill Venners", "Frank Sommers"), 2018)
  val book2: Book = Book("Zionomicon", List("John A. De Goes", "Adam Fraser"), 2023)
  val book3: Book = Book("Effect-Oriented Programming", List("Bill Frasure", "Bruce Eckel", "James Ward"), 2009)
  def find(q: String): List[Book] = 
